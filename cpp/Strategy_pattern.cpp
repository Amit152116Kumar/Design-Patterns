...
public:
    ...
    virtual ~PaymentInterface(){
        cout<<"Payment Method Deleted"<<endl;
    }
};
...
public:
    Customer(string firstName, string lastName, string address, string phone, string email){
...
// ---------------------------------------------Customer Concrete Classes-------------------------------------
class KotakCustomer:public Customer{
public:
    KotakCustomer(string firstName,string lastName,string address,string phone, string email):Customer(firstName,lastName, address, phone, email){
...
public:
    ICICICustomer(string firstName,string lastName,string address,string phone, string email):Customer(firstName,lastName, address, phone, email){
...
public:
    HDFCCustomer(string firstName,string lastName,string address,string phone, string email):Customer(firstName,lastName, address, phone, email){
...
public:
    SBICustomer(string firstName,string lastName,string address,string phone, string email):Customer(firstName,lastName, address, phone, email){
...
int main(){
    ...
    Customer *amit = new KotakCustomer("Amit","Kumar","Delhi","1234567890","amit152116@gmail.com");
    cout<<amit->getCustomerId()<<endl;
    amit->display();
    amit->makePayment();
    cout<<endl;

    Customer *sumit = new ICICICustomer("Sumit","Kumar","Delhi","1234567890","sumit@gmail.com");
    ...
    Customer *ram = new HDFCCustomer("Ram","Kumar","Delhi","1234567890","asldkjfa@gmail.com");
    cout<<ram->getCustomerId()<<endl;
    ram->display();
    ram->makePayment();
    cout<<endl;

    Customer *shyam = new SBICustomer("Shyam","Kumar","Delhi","1234567890","alsj@mail.com");

...
/* Abstract Factory Pattern
    ...
    Note:
        ...
        2. Abstract Factory Pattern provides a way to encapsulate a group of individual factories 
           that have a common theme without specifying their concrete classes.
        3. Abstract Factory Pattern is often implemented with Factory Method Pattern.
*/
...
class NYStyleCheesePizza: public Pizza{
    public:
        void prepare(){
            cout<<"NYStyleCheesePizza prepare"<<endl;
        }
        void bake(){
            cout<<"NYStyleCheesePizza bake"<<endl;
        }
        void cut(){
            cout<<"NYStyleCheesePizza cut"<<endl;
        }
        void box(){
...
class NYStyleVeggiePizza: public Pizza{
    public:
        void prepare(){
            cout<<"NYStyleVeggiePizza prepare"<<endl;
        }
        void bake(){
            cout<<"NYStyleVeggiePizza bake"<<endl;
        }
        void cut(){
            cout<<"NYStyleVeggiePizza cut"<<endl;
        }
        void box(){
...
class ChicagoStyleCheesePizza: public Pizza{
    public:
        void prepare(){
            cout<<"ChicagoStyleCheesePizza prepare"<<endl;
        }
        void bake(){
            cout<<"ChicagoStyleCheesePizza bake"<<endl;
        }
        void cut(){
            cout<<"ChicagoStyleCheesePizza cut"<<endl;
        }
        void box(){
...
class ChicagoStyleVeggiePizza: public Pizza{
    public:
        void prepare(){
            cout<<"ChicagoStyleVeggiePizza prepare"<<endl;
        }
        void bake(){
            cout<<"ChicagoStyleVeggiePizza bake"<<endl;
        }
        void cut(){
            cout<<"ChicagoStyleVeggiePizza cut"<<endl;
        }
        void box(){

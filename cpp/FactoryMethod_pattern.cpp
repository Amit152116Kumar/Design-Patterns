...
/* Factory Method Pattern
    ...
    Note:
        1. Factory Method is a good choice when you don't know ahead of time what class object you
            need.
        2. Factory Method is a good choice when you want to localize the knowledge of which class
            gets created.
        3. Factory Method is a good choice when you want to give users of the framework a way to
            extend or replace the framework's components.
        4. Factory Method is a good choice when you want to promote loose coupling.
